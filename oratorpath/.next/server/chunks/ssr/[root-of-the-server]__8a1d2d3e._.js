...
__turbopack_context__.v((parentImport) => {
    return Promise.all([
  "server/chunks/ssr/node_modules_@clerk_nextjs_dist_esm_app-router_f3d691fd._.js"
...
__turbopack_context__.v((parentImport) => {
    return Promise.all([
  "server/chunks/ssr/node_modules_@clerk_nextjs_dist_esm_app-router_5f8feb3f._.js"
].map((chunk) => __turbopack_context__.l(chunk))).then(() => {
...
"[project]/src/app/components/Footer.jsx [app-ssr] (ecmascript, next/dynamic entry, async loader)": ((__turbopack_context__) => {

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.v((parentImport) => {
    return Promise.all([
  "server/chunks/ssr/node_modules_a442cddf._.js",
  "server/chunks/ssr/src_app_components_Footer_jsx_6b7e5182._.js"
].map((chunk) => __turbopack_context__.l(chunk))).then(() => {
        return parentImport("[project]/src/app/components/Footer.jsx [app-ssr] (ecmascript, next/dynamic entry)");
    });
});
}}),
"[project]/src/app/components/SimpleFooter.jsx [app-ssr] (ecmascript, next/dynamic entry, async loader)": ((__turbopack_context__) => {
...
__turbopack_context__.v((parentImport) => {
    return Promise.all([
  "server/chunks/ssr/node_modules_a442cddf._.js",
  "server/chunks/ssr/src_app_components_SimpleFooter_jsx_933325da._.js"
].map((chunk) => __turbopack_context__.l(chunk))).then(() => {
        return parentImport("[project]/src/app/components/SimpleFooter.jsx [app-ssr] (ecmascript, next/dynamic entry)");
    });
});
}}),
