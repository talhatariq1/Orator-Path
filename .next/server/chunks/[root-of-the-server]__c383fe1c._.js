...
"[project]/.next-internal/server/app/api/practice-sessions/[id]/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/practice-sessions/[id]/route.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    // We need to await params to avoid the "params should be awaited" error
    const resolvedParams = await Promise.resolve(params);
    console.log(`API route called: /api/practice-sessions/${resolvedParams.id}`);
    try {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c383fe1c._.js.map