...
"[project]/.next-internal/server/app/api/practice-sessions/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/practice-sessions/route.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    try {
        ...
        const connectionResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$apiUtils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["connectToMongoDB"])(3000);
        if (!connectionResult.success) {
        ...
        const countResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$apiUtils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["handleMongoQuery"])(async ()=>await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$models$2f$audioAnalysis$2e$model$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].countDocuments(query), 'Failed to count practice sessions', {
            maxRetries: 2,
            retryDelay: 300,
            timeout: 3000,
        ...
        const sessionsResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$apiUtils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["handleMongoQuery"])(async ()=>await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$models$2f$audioAnalysis$2e$model$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find(query).sort(sort).skip(skip).limit(limit), 'Failed to fetch practice sessions', {
            maxRetries: 2,
            retryDelay: 300,
            timeout: 3000,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f8ef1c83._.js.map