...
async function GET() {
    try {
        ...
        // Check cache first
        const cacheKey = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$apiUtils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateCacheKey"])(userId, 'practice-consistency');
        const cachedData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$apiUtils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getFromCache"])(cacheKey, 3 * 60 * 1000); // 3 minute cache
        if (cachedData) {
        ...
        const practiceData = analyses.map((analysis)=>{
            // Extract date
            const date = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$apiUtils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["formatDateForDisplay"])(analysis.analysisDate || analysis.createdAt);
            // Extract duration
...
//# sourceMappingURL=%5Broot-of-the-server%5D__780dbc43._.js.map