...
async function GET() {
    try {
        ...
        const cacheKey = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$apiUtils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateCacheKey"])('global', 'daily-speaking-tip', {
            day: currentDayOfWeek
        });
        const cachedData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$apiUtils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getFromCache"])(cacheKey, 12 * 60 * 60 * 1000); // 12 hour cache
        if (cachedData) {
        ...
        const dbConnection = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$apiUtils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["connectToMongoDB"])(5000); // 5 second timeout for daily tips
        if (!dbConnection.success) {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$apiUtils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["saveToCache"])(cacheKey, defaultResponse);
        ...
        const queryResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$apiUtils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["handleMongoQuery"])(async ()=>{
            return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$models$2f$speakingTip$2e$model$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
        ...
        if (!queryResult.success) {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$apiUtils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["saveToCache"])(cacheKey, errorResponse);
        ...
        // Cache the successful response
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$apiUtils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["saveToCache"])(cacheKey, successResponse);
...
async function POST(req) {
    try {
        ...
        if (data.reset) {
            const deleteResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$apiUtils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["handleMongoQuery"])(async ()=>{
                const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$models$2f$speakingTip$2e$model$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].deleteMany({});
                return result;
        ...
        if (data.tips && Array.isArray(data.tips)) {
            ...
            if (validTips.length > 0) {
                const updateResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$apiUtils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["handleMongoQuery"])(async ()=>{
        ...
        const tipsResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$apiUtils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["handleMongoQuery"])(async ()=>{
            return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$models$2f$speakingTip$2e$model$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find().sort({
                dayOfWeek: 1
            }).lean();
        ...
        for(let day = 0; day <= 6; day++){
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$apiUtils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["saveToCache"])(cacheKey, null);
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2fc6710c._.js.map