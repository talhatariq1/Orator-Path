...
"[project]/src/app/components/client/VideoSvdProvider.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
/**
 * This component ensures consistent behavior between server and client rendering
 * for the video SVD attribute on the body element.
 */ const VideoSvdProvider = ()=>{
    _s();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "VideoSvdProvider.useEffect": ()=>{
            // Remove the inject_video_svd attribute if it exists
            // This ensures client-side rendering matches the server
...
_s(VideoSvdProvider, "OD7bBpZva5O2jO+Puf00hKivP7c=");
_c = VideoSvdProvider;
const __TURBOPACK__default__export__ = VideoSvdProvider;
var _c;
__turbopack_context__.k.register(_c, "VideoSvdProvider");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_app_components_c00e374a._.js.map