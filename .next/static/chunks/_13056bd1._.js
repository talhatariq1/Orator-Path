 ...
 * @param {string} props.redirectTo - URL to redirect to
 * @param {boolean} props.ifAuthenticated - Redirect if user is authenticated
 * @param {boolean} props.ifUnauthenticated - Redirect if user is not authenticated
 * @param {boolean} props.forceRedirect - Use window.location.href instead of router.push
 * @param {number} props.delay - Delay in ms before redirecting
            ...
            if (redirectUrl.startsWith('/')) {
                ...
                try {
                    ...
                    if (redirectDomain === currentDomain) {
                        ...
                        console.warn('Attempted redirect to external domain:', redirectUrl);
...
const handlePostAuthRedirect = (router, defaultRedirect = '/dashboard')=>{
    if ("TURBOPACK compile-time falsy", 0) {
        "TURBOPACK unreachable";
    }
    try {
        // Get the redirect URL from the query parameters or use default
        const urlParams = new URLSearchParams(window.location.search);
        let redirectUrl = urlParams.get('redirect_url') || defaultRedirect;
        // Safely decode the URL if it's encoded
        redirectUrl = safeDecodeURIComponent(redirectUrl);
        console.log('Post-auth redirect - redirecting to:', redirectUrl);
        // Validate and perform the redirect
        if (redirectUrl.startsWith('/')) {
...
"[project]/src/app/components/auth/SignInWrapper.jsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/navigation.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$nextjs$2f$dist$2f$esm$2f$client$2d$boundary$2f$PromisifiedAuthProvider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__usePromisifiedAuth__as__useAuth$3e$__ = __turbopack_context__.i("[project]/node_modules/@clerk/nextjs/dist/esm/client-boundary/PromisifiedAuthProvider.js [app-client] (ecmascript) <export usePromisifiedAuth as useAuth>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$auth$2f$AuthRedirect$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/components/auth/AuthRedirect.jsx [app-client] (ecmascript)");
 ...
 * Wraps the Clerk SignIn component and handles redirection after successful login
 *
 * @param {Object} props - Component props
 * @param {React.ReactNode} props.children - Child components (Clerk SignIn)
 */ const SignInWrapper = ({ children })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SignInWrapper.useEffect": ()=>{
            ...
            if (isSignedIn) {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2f$authUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["handlePostAuthRedirect"])(router);
            }
        }
    }["SignInWrapper.useEffect"], [
        isLoaded,
    ...
    // Use AuthRedirect to handle redirection when user is already authenticated
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$auth$2f$AuthRedirect$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                redirectTo: "/dashboard",
                ifAuthenticated: true,
                forceRedirect: false
            }, void 0, false, {
                fileName: "[project]/src/app/components/auth/SignInWrapper.jsx",
                lineNumber: 34,
                columnNumber: 7
            }, this),
            children
...
_s(SignInWrapper, "mj3FTF/jDPciKMm8S5gTwEqBZAY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$nextjs$2f$dist$2f$esm$2f$client$2d$boundary$2f$PromisifiedAuthProvider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__usePromisifiedAuth__as__useAuth$3e$__["useAuth"]
    ];
...
_c = SignInWrapper;
const __TURBOPACK__default__export__ = SignInWrapper;
var _c;
...
//# sourceMappingURL=_13056bd1._.js.map