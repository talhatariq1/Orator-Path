...
"[project]/src/app/components/auth/RedirectToDashboard.jsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
 ...
 * A simple component that redirects to the dashboard immediately
 */ const RedirectToDashboard = ()=>{
    ...
    const [redirectAttempted, setRedirectAttempted] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [redirectStatus, setRedirectStatus] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('Initializing...');
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RedirectToDashboard.useEffect": ()=>{
            if (!isLoaded) {
                setRedirectStatus('Loading authentication state...');
                return;
            }
            if (!redirectAttempted) {
                setRedirectAttempted(true);
                if (isSignedIn) {
                    setRedirectStatus('Authentication confirmed. Redirecting to dashboard...');
                    ...
                    setTimeout({
                        "RedirectToDashboard.useEffect": ()=>{
                            try {
                                ...
                                // Also try the router as a fallback
                                router.push('/dashboard');
                            } catch (error) {
                                console.error("Error during redirect:", error);
                                setRedirectStatus('Redirect failed. Please use the link below.');
                            }
                        }
                    }["RedirectToDashboard.useEffect"], 500);
                } else {
                    setRedirectStatus('Not authenticated. Redirecting to sign-in...');
                    ...
                    setTimeout({
                        "RedirectToDashboard.useEffect": ()=>{
                            try {
                                ...
                                console.error("Error during redirect to sign-in:", error);
                                setRedirectStatus('Redirect failed. Please use the link below.');
                            }
                        }
                    }["RedirectToDashboard.useEffect"], 500);
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                    ...
                    fileName: "[project]/src/app/components/auth/RedirectToDashboard.jsx",
                    lineNumber: 63,
                    columnNumber: 9
                }, this),
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    className: "text-gray-300",
                    children: redirectStatus
                }, void 0, false, {
                    fileName: "[project]/src/app/components/auth/RedirectToDashboard.jsx",
                    lineNumber: 64,
                    columnNumber: 9
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: "If you are not redirected automatically:"
                        }, void 0, false, {
                            fileName: "[project]/src/app/components/auth/RedirectToDashboard.jsx",
                            lineNumber: 69,
                            columnNumber: 11
...
_s(RedirectToDashboard, "bTN2uwLo/eKp9pWeiyZUy8KD7VU=", false, function() {
    return [
...
_c = RedirectToDashboard;
const __TURBOPACK__default__export__ = RedirectToDashboard;
var _c;
__turbopack_context__.k.register(_c, "RedirectToDashboard");
...
//# sourceMappingURL=_c4711f7b._.js.map