 ...
 */ const CustomSignOutButton = ({ redirectUrl = '/', children })=>{
    ...
    const [isSignedOut, setIsSignedOut] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    // Get the signOut function from clerk
    const signOut = clerk?.signOut;
    // Handle redirection after sign-out
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CustomSignOutButton.useEffect": ()=>{
            if (isSignedOut) {
                // Use a small delay to ensure the sign-out process completes
                const redirectTimer = setTimeout({
                    "CustomSignOutButton.useEffect.redirectTimer": ()=>{
                        router.push(redirectUrl);
                    }
                }["CustomSignOutButton.useEffect.redirectTimer"], 300);
                return ({
                    "CustomSignOutButton.useEffect": ()=>clearTimeout(redirectTimer)
                })["CustomSignOutButton.useEffect"];
            }
        }
    }["CustomSignOutButton.useEffect"], [
    ...
    const handleSignOut = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CustomSignOutButton.useCallback[handleSignOut]": async ()=>{
            ...
            try {
                ...
                }["CustomSignOutButton.useCallback[handleSignOut]"], 300);
            }
        }
    }["CustomSignOutButton.useCallback[handleSignOut]"], [
        clerk,
...
_s(CustomSignOutButton, "cXA1UxWNH+GTlFFY0DSZY23Po0s=", false, function() {
    return [
...
"[project]/src/app/components/common/ErrorBoundary.jsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
_s(ErrorBoundaryWrapper, "fN7XvhJ+p5oE6+Xlo0NJmXpxjC8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$dashboard$2f$ui$2f$WidgetCard$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/components/dashboard/ui/WidgetCard.jsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$common$2f$ErrorBoundary$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/components/common/ErrorBoundary.jsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Dashboard.useEffect": ()=>{
            if ("TURBOPACK compile-time truthy", 1) {
                ...
                console.error = ({
                    "Dashboard.useEffect": function(...args) {
        ...
        "Dashboard.useEffect": ()=>{
            if (isUserLoaded && user) {
                ...
                const fetchAllDashboardData = {
                    "Dashboard.useEffect.fetchAllDashboardData": async ()=>{
                        try {
                            // Wrap each fetch in a try/catch to prevent unhandled promise rejections
                            const safelyFetch = {
                                "Dashboard.useEffect.fetchAllDashboardData.safelyFetch": async (fetchFn, isInitialLoad)=>{
                                    try {
                            ...
                            }["Dashboard.useEffect.fetchAllDashboardData.safelyFetch"];
                            ...
                            const failedFetches = results.filter({
                                "Dashboard.useEffect.fetchAllDashboardData.failedFetches": (r)=>r.status === 'rejected' || r.status === 'fulfilled' && r.value?.success === false
                            }["Dashboard.useEffect.fetchAllDashboardData.failedFetches"]);
                            if (failedFetches.length > 0) {
                                ...
                                setTimeout({
                                    "Dashboard.useEffect.fetchAllDashboardData": ()=>{
                                        results.forEach({
                                            "Dashboard.useEffect.fetchAllDashboardData": (result, index)=>{
                                ...
                                }["Dashboard.useEffect.fetchAllDashboardData"], 2000);
                            }
                        } catch (error) {
...
_s(Dashboard, "AlUaw8P3TjKceVSSytAXWcwkDHw=", false, function() {
    return [
...
function DashboardWithErrorBoundary() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$common$2f$ErrorBoundary$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
...
_c1 = DashboardWithErrorBoundary;
var _c, _c1;
__turbopack_context__.k.register(_c, "Dashboard");
__turbopack_context__.k.register(_c1, "DashboardWithErrorBoundary");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_2a1e3367._.js.map