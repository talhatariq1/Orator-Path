    ...
    try {
        ...
        const checkPageBreak = (neededSpace)=>{
            if (yPos + neededSpace > 280) {
                ...
                doc.setFontSize(14);
                doc.setTextColor(colors.text.r, colors.text.g, colors.text.b);
                doc.text('Orator Path - Speech Analysis Report', pageWidth / 2, 15, {
                    align: 'center'
                });
                // Add separator line
                doc.setDrawColor(colors.border.r, colors.border.g, colors.border.b);
        ...
        tocItems.forEach((item, index)=>{
            ...
            doc.text(`Page ${item.page}`, pageWidth - margin, yPos, {
                align: 'right'
            });
            yPos += 10;
        });
        ...
        const coherenceScore = safeGet(analysis, 'textCoherence.score') || safeGet(analysis, 'text_analysis.coherence.score');
        ...
        const duration = safeGet(analysis, 'duration') || safeGet(analysis, 'voice_analysis.duration') || 0;
        const speakingRate = safeGet(analysis, 'speakingRate') || safeGet(analysis, 'voice_analysis.speaking_rate') || 0;
        const pitch = safeGet(analysis, 'pitch.average') || safeGet(analysis, 'voice_analysis.pitch.average') || 0;
        const volume = safeGet(analysis, 'volume.average') || safeGet(analysis, 'voice_analysis.volume.average') || 0;
        // Duration card
        ...
        doc.setFont(undefined, 'bold');
        doc.setFontSize(12);
        doc.text('🔊', margin + cardWidth + 30, yPos + 23, {
            align: 'center'
        });
        doc.setFont(undefined, 'normal');
        // Add title
        ...
        const volumeVar = safeGet(analysis, 'volume.variability') || safeGet(analysis, 'voice_analysis.volume.variability') || 0;
        if (volumeVar) {
            doc.setFontSize(10);
        ...
        // Add value
        const pauseCount = safeGet(analysis, 'pauses.count') || safeGet(analysis, 'voice_analysis.pauses.count') || 0;
        doc.setFontSize(28);
        doc.setTextColor(colors.text.r, colors.text.g, colors.text.b);
        ...
        const pauseAvgDuration = safeGet(analysis, 'pauses.average_duration') || safeGet(analysis, 'voice_analysis.pauses.average_duration') || 0;
        if (pauseAvgDuration) {
            doc.setFontSize(10);
        ...
        const spectralCentroid = safeGet(analysis, 'voice_quality.spectral_centroid') || safeGet(analysis, 'voice_analysis.voice_quality.spectral_centroid') || 0;
        doc.setFontSize(12);
        doc.setTextColor(colors.text.r, colors.text.g, colors.text.b);
        doc.text(`Spectral Centroid: ${formatNumber(spectralCentroid, 1)}`, margin + cardWidth + 50, yPos + 45);
        // Add spectral bandwidth
        const spectralBandwidth = safeGet(analysis, 'voice_quality.spectral_bandwidth') || safeGet(analysis, 'voice_analysis.voice_quality.spectral_bandwidth') || 0;
        ...
        const wordCount = safeGet(analysis, 'text_analysis.text_statistics.word_count') || safeGet(analysis, 'textStatistics.wordCount') || 0;
        const sentenceCount = safeGet(analysis, 'text_analysis.text_statistics.sentence_count') || safeGet(analysis, 'textStatistics.sentenceCount') || 0;
        const wordsPerSentence = safeGet(analysis, 'text_analysis.text_statistics.average_words_per_sentence') || safeGet(analysis, 'textStatistics.wordsPerSentence') || 0;
        const vocabularyRichness = safeGet(analysis, 'text_analysis.text_statistics.vocabulary_richness') || safeGet(analysis, 'textStatistics.vocabularyRichness') || 0;
        ...
        doc.setFont(undefined, 'bold');
        doc.setFontSize(12);
        doc.text('S', margin + statCardWidth + 30, yPos + 23, {
            align: 'center'
        });
        doc.setFont(undefined, 'normal');
        // Add title
        ...
        doc.setFont(undefined, 'bold');
        doc.setFontSize(10);
        doc.text('W/S', margin + 20, yPos + 23, {
            align: 'center'
        });
        doc.setFont(undefined, 'normal');
        // Add title
        ...
        doc.setFont(undefined, 'bold');
        doc.setFontSize(12);
        doc.text('V', margin + statCardWidth + 30, yPos + 23, {
            align: 'center'
        });
        doc.setFont(undefined, 'normal');
        // Add title
        ...
        const readability = safeGet(analysis, 'text_analysis.readability.reading_level') || safeGet(analysis, 'contentAnalysis.readability') || 'Standard';
        const fleschScore = safeGet(analysis, 'text_analysis.readability.flesch_reading_ease') || safeGet(analysis, 'contentAnalysis.fleschReadingEase') || 0;
        const nounVerbRatio = safeGet(analysis, 'text_analysis.content_analysis.noun_verb_ratio') || safeGet(analysis, 'contentAnalysis.nounVerbRatio') || 0;
        const fillerWords = safeGet(analysis, 'text_analysis.filler_words.total_count') || safeGet(analysis, 'fillerWords.count') || 0;
        const fillerPercentage = safeGet(analysis, 'text_analysis.filler_words.percentage') || safeGet(analysis, 'fillerWords.percentage') || 0;
        ...
        doc.setFont(undefined, 'bold');
        doc.setFontSize(10);
        doc.text('N:V', margin + statCardWidth + 30, yPos + 23, {
            align: 'center'
        });
        doc.setFont(undefined, 'normal');
        // Add title
        ...
        doc.setFont(undefined, 'bold');
        doc.setFontSize(12);
        doc.text('F', margin + statCardWidth + 30, yPos + 23, {
            align: 'center'
        });
        doc.setFont(undefined, 'normal');
        // Add title
        ...
        if (Object.keys(emotionDistribution).length > 0) {
            ...
            const sortedEmotions = Object.entries(emotionDistribution).sort((a, b)=>b[1] - a[1]).slice(0, 5);
        ...
        if (commonWords.length > 0) {
            ...
            topWords.forEach(([word, count], index)=>{
                ...
                doc.setTextColor(colors.black.r, colors.black.g, colors.black.b);
                doc.text(word, bubbleCenterX, bubbleCenterY - 5, {
                    align: 'center'
                });
                // Add count text
                doc.setFontSize(9);
                doc.setTextColor(colors.gray.r, colors.gray.g, colors.gray.b);
                doc.text(`${count} times`, bubbleCenterX, bubbleCenterY + 5, {
                    align: 'center'
                });
            });
            yPos += 60;
        ...
        if (Object.keys(fillerWordsDetails).length > 0) {
            ...
            doc.text('Count', margin + contentWidth / 4, yPos + 8, {
                align: 'center'
            });
            doc.text('Word', margin + contentWidth / 2 + 10, yPos + 8);
            doc.text('Count', margin + contentWidth * 3 / 4 + 5, yPos + 8, {
                align: 'center'
            });
            yPos += rowHeight;
            // Draw table rows
            for(let i = 0; i < tableRows; i++){
                ...
                if (i < fillerWordsArray.length) {
                    ...
                    doc.setTextColor(colors.black.r, colors.black.g, colors.black.b);
                    doc.text(word, margin + 5, yPos + 8);
                    doc.text(count.toString(), margin + contentWidth / 4, yPos + 8, {
                        align: 'center'
                    });
                }
                // Right column
                if (i + tableRows < fillerWordsArray.length) {
                    ...
                    doc.setTextColor(colors.black.r, colors.black.g, colors.black.b);
                    doc.text(word, margin + contentWidth / 2 + 10, yPos + 8);
                    doc.text(count.toString(), margin + contentWidth * 3 / 4 + 5, yPos + 8, {
                        align: 'center'
                    });
                }
        ...
        const overallScore = safeGet(analysis, 'performance_assessment.overall_score') || safeGet(analysis, 'recommendations.performance_assessment.overall_score') || safeGet(analysis, 'performanceAssessment.overallScore') || 0;
        const performanceLevel = safeGet(analysis, 'performance_assessment.performance_level') || safeGet(analysis, 'recommendations.performance_assessment.performance_level') || safeGet(analysis, 'performanceAssessment.performanceLevel') || 'Average';
        const strengths = safeGet(analysis, 'performance_assessment.strengths') || safeGet(analysis, 'recommendations.performance_assessment.detailed_strengths') || safeGet(analysis, 'performanceAssessment.strengths') || [];
        const improvements = safeGet(analysis, 'performance_assessment.areas_for_improvement') || safeGet(analysis, 'recommendations.performance_assessment.growth_areas') || safeGet(analysis, 'performanceAssessment.areasForImprovement') || [];
        ...
        if (priorityImprovements.length > 0) {
            ...
            priorityImprovements.forEach((priority, index)=>{
                ...
                doc.setFontSize(12);
                doc.setTextColor(colors.white.r, colors.white.g, colors.white.b);
                doc.text((index + 1).toString(), margin + 15, yPos + 18, {
                    align: 'center'
                });
                // Priority title
                doc.setFontSize(11);
        ...
        if (recommendations.length > 0) {
            ...
            recommendations.forEach((rec, index)=>{
                ...
                doc.setFontSize(10);
                doc.setTextColor(colors.white.r, colors.white.g, colors.white.b);
                doc.text((index + 1).toString(), margin + 10, yPos + 18, {
                    align: 'center'
                });
                // Draw timeline line
                ...
                if (rec.exercises && rec.exercises.length > 0) {
                    ...
                    rec.exercises.forEach((exercise, i)=>{
                        ...
                        doc.setFontSize(8);
                        doc.setTextColor(colors.primary.r, colors.primary.g, colors.primary.b);
                        doc.text((i + 1).toString(), margin + 45, yPos + 5, {
                            align: 'center'
                        });
                        // Add exercise text
                        doc.setFontSize(9);
        ...
        if (developmentPlan) {
            ...
            if (pathway.length > 0) {
                ...
                pathway.forEach((stage, index)=>{
                    ...
                    doc.setFontSize(10);
                    doc.setTextColor(colors.white.r, colors.white.g, colors.white.b);
                    doc.text((index + 1).toString(), stageX, yPos + roadHeight / 2 + 3, {
                        align: 'center'
                    });
                    // Add stage name below
                    doc.setFontSize(9);
                    doc.setTextColor(colors.secondary.r, colors.secondary.g, colors.secondary.b);
                    doc.text(stage.stage, stageX, yPos + roadHeight + 15, {
                        align: 'center'
                    });
                });
                yPos += roadHeight + 30;
                ...
                pathway.forEach((stage, index)=>{
                    ...
                    doc.setFontSize(10);
                    doc.setTextColor(colors.white.r, colors.white.g, colors.white.b);
                    doc.text((index + 1).toString(), margin + 15, yPos + 15, {
                        align: 'center'
                    });
                    // Add stage title
                    doc.setFontSize(12);
                    ...
                    if (stage.exercises && stage.exercises.length > 0) {
                        ...
                        stage.exercises.forEach((exercise, exIndex)=>{
                            ...
                            doc.setFontSize(8);
                            doc.setTextColor(colors.secondary.r, colors.secondary.g, colors.secondary.b);
                            doc.text((exIndex + 1).toString(), margin + 22, yPos + 4, {
                                align: 'center'
                            });
                            // Add exercise text
                            doc.setFontSize(9);
        ...
        for(let i = 1; i <= pageCount; i++){
            ...
            // Add page numbers
            doc.text(`Page ${i} of ${pageCount}`, pageWidth - margin, 288, {
                align: 'right'
            });
            ...
            if (i >= 3) {
                ...
                doc.setTextColor(colors.primary.r, colors.primary.g, colors.primary.b);
                doc.text(sectionName, pageWidth / 2, 288, {
                    align: 'center'
                });
            }
        }
        ...
        for(let i = 0; i < 10; i++){
            for(let j = 0; j < 10; j++){
                if (Math.random() > 0.7 || i < 3 && j < 3 || i < 3 && j > 6 || i > 6 && j < 3) {
...
const DashboardLayout = ({ children })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DashboardLayout.useEffect": ()=>{
            ...
            if (isLoaded && userId) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2f$authUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["preventSignInRedirect"])(router);
            }
...
_s(DashboardLayout, "AqbQclAgtj/XzHHDaPWXhaw9OnY=", false, function() {
    return [
...
"[project]/src/app/dashboard/audio-analysis/page.jsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function AudioAnalysis() {
    ...
    const [processingAnimation, setProcessingAnimation] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const [audioSource, setAudioSource] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("upload");
    const [isResetMode, setIsResetMode] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const canvasRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const audioAnalyserRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const visualizationIntervalRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
                ...
                "AudioAnalysis.useEffect": ()=>{
                    ...
                    if (streamRef.current) {
                        streamRef.current.getTracks().forEach({
                            "AudioAnalysis.useEffect": (track)=>track.stop()
                        }["AudioAnalysis.useEffect"]);
                    }
    ...
    const downloadPdfReport = async ()=>{
        ...
        try {
            ...
            const doc = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$pdfGenerator$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateAnalysisPDF"])(analysis);
            if (doc) {
    ...
    const renderAudioInputSelectors = ()=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "mb-6",
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        !isRecording && !file && !isResetMode && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        !isRecording && isResetMode && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "absolute inset-0 flex items-center justify-center text-gray-500",
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                            ...
                            children: [
                                ...
                                Object.keys(safeGet(text, 'filler_words.occurrences', {})).length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                    className: "text-gray-400 mt-2 list-disc list-inside space-y-1 text-sm",
                                    children: Object.entries(safeGet(text, 'filler_words.occurrences', {})).slice(0, 3).map(([word, count])=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                            ...
                            children: [
                                ...
                                safeGet(text, 'content_analysis.most_common_words', []).length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                    className: "text-gray-400 list-disc list-inside space-y-1 text-xs",
                                    children: safeGet(text, 'content_analysis.most_common_words', []).slice(0, 3).map(([w, c], i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                            children: `"${w}" - ${c} times`
                                        }, i, false, {
                                            fileName: "[project]/src/app/dashboard/audio-analysis/page.jsx",
                                            lineNumber: 793,
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                            ...
                            children: [
                                ...
                                Object.keys(safeGet(text, 'emotion_analysis.emotion_distribution', {})).length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "mt-3 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-4 gap-y-2",
                                    children: Object.entries(safeGet(text, 'emotion_analysis.emotion_distribution', {})).sort(([, a], [, b])=>b - a).map(([emotion, perc])=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "flex items-center",
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
    ...
    const renderRecommendations = ()=>{
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                Object.keys(performanceAssessment).length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                safeGet(performanceAssessment, 'priority_improvements', []).length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "bg-gray-800/50 p-5 rounded-lg shadow-md border border-gray-700/40 mb-6",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "flex items-center mb-3",
                ...
                specificRecommendations.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "bg-gray-800/50 p-5 rounded-lg shadow-md border border-gray-700/40 mb-6",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "flex items-center mb-3",
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "space-y-4",
                            children: specificRecommendations.map((rec, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                Object.keys(developmentPlan).length > 0 && (safeGet(developmentPlan, 'next_steps', []).length > 0 || safeGet(developmentPlan, 'development_pathway', []).length > 0) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        safeGet(developmentPlan, 'next_steps', []).length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "mb-5",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                        ...
                        safeGet(developmentPlan, 'development_pathway', []).length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "space-y-5",
                                    children: safeGet(developmentPlan, 'development_pathway', []).map((stage, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                stage.focus_areas && stage.focus_areas.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "mt-2",
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                                            className: "list-disc pl-5 text-sm mt-1 space-y-0.5",
                                                            children: stage.focus_areas.map((area, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                                    className: "text-gray-400",
                                                                    children: area
                                                                }, i, false, {
                                                                    fileName: "[project]/src/app/dashboard/audio-analysis/page.jsx",
                                                ...
                                                stage.exercises && stage.exercises.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "mt-2",
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h5", {
                                                            className: "text-xs font-semibold text-gray-500 uppercase tracking-wider",
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                                            className: "list-disc pl-5 text-sm mt-1 space-y-0.5",
                                                            children: stage.exercises.map((exercise, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                                    className: "text-gray-400",
                                                                    children: exercise
                                                                }, i, false, {
                                                                    fileName: "[project]/src/app/dashboard/audio-analysis/page.jsx",
                                                ...
                                                stage.milestone && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        safeGet(developmentPlan, 'tracking_template.weekly_focus') && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "mt-5",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                    className: "font-semibold text-purple-300 text-lg mb-2",
                                    ...
                                    children: [
                                        ...
                                        safeGet(developmentPlan, 'tracking_template.metrics_to_track', []).length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                                    className: "list-disc pl-5 text-sm mt-1 space-y-0.5",
                                                    children: safeGet(developmentPlan, 'tracking_template.metrics_to_track', []).map((metric, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                            className: "text-gray-400",
                                                            children: metric
                                                        }, i, false, {
                                                            fileName: "[project]/src/app/dashboard/audio-analysis/page.jsx",
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        file && audioSource === "record" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$dashboard$2f$DashboardLayout$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$components$2f$AnimatePresence$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AnimatePresence"], {
                children: processingAnimation && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ProcessingAnimation, {}, void 0, false, {
                    fileName: "[project]/src/app/dashboard/audio-analysis/page.jsx",
                    lineNumber: 1095,
                    columnNumber: 48
                }, this)
...
_s(AudioAnalysis, "3U2opdudMvDsyS3Phm/+x/t7oM4=", false, function() {
    return [
...
_c = AudioAnalysis;
var _c;
__turbopack_context__.k.register(_c, "AudioAnalysis");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_b18be22c._.js.map