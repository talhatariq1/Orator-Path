...
const DailySpeakingTipWidget = ()=>{
    ...
    // Fetch the daily tip from the API
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DailySpeakingTipWidget.useEffect": ()=>{
            const fetchDailyTip = {
                "DailySpeakingTipWidget.useEffect.fetchDailyTip": async ()=>{
                    try {
                        ...
                        const timeoutId = setTimeout({
                            "DailySpeakingTipWidget.useEffect.fetchDailyTip.timeoutId": ()=>controller.abort()
                        }["DailySpeakingTipWidget.useEffect.fetchDailyTip.timeoutId"], 10000); // 10 second timeout
                        try {
                            const response = await fetch('/api/daily-speaking-tip', {
                            ...
                            if (!response.ok) {
                                throw new Error(`Failed to fetch daily speaking tip: ${response.status} ${response.statusText}`);
                            }
                            const data = await response.json();
...
_s(DailySpeakingTipWidget, "t1E8BZ4UZ4iQuIJuMzxwE58qPQU=");
...
//# sourceMappingURL=src_f383900c._.js.map