        ...
        "Page.useEffect": ()=>{
            if (isLoaded && isSignedIn) {
                ...
                if (redirectUrl.startsWith('http')) {
                    ...
                    }["Page.useEffect.redirectTimer"], 300);
                    return ({
                        "Page.useEffect": ()=>clearTimeout(redirectTimer)
                    })["Page.useEffect"];
                }
            }
        }
...
_s(Page, "y8cKMcwTkXntxMrG7RngZJH2+58=", false, function() {
    return [
...
//# sourceMappingURL=_1b3f1cef._.js.map