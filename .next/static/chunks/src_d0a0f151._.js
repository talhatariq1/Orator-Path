...
const checkClockSkew = async ()=>{
    try {
        // Get the client time before the request
        const clientTime = new Date();
        // Fetch the server time
        const response = await fetch('/api/debug/server-time');
        if (!response.ok) {
        ...
        const diffSeconds = Math.abs(Math.round((clientTime - serverTime) / 1000));
        // Consider clock skew if difference is more than 5 seconds
        const isSkewed = diffSeconds > 5;
        return {
            isSkewed,
            diffSeconds,
            serverTime,
...
const handleAuthError = async (error, router)=>{
    // Check if this is a clock skew issue
    if (error.message?.includes('token-iat-in-the-future') || error.message?.includes('JWT issued at date claim')) {
        const skewCheck = await checkClockSkew();
        if (skewCheck.isSkewed) {
            // Redirect to the clock fix page
            router.push('/debug/fix-system-time');
            return {
                handled: true,
                message: `Your system clock is out of sync by ${skewCheck.diffSeconds} seconds. Please fix your system time.`
            };
        }
    }
    // Check for redirect loop
    if (error.message?.includes('infinite redirect loop') || error.message?.includes('NEXT_REDIRECT')) {
        // Clear any Clerk-related cookies and local storage
        if ("TURBOPACK compile-time truthy", 1) {
            // Clear cookies related to Clerk
            document.cookie.split(';').forEach((cookie)=>{
                const [name] = cookie.trim().split('=');
                if (name.includes('__clerk') || name.includes('__session')) {
                    document.cookie = `${name}=; expires=Thu, 01 Jan 1970 00:00:00 GMT; path=/`;
                }
            });
            // Clear local storage related to Clerk
        ...
        return {
            handled: true,
            message: 'Authentication session was reset due to an issue. Please sign in again.'
        };
    }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DashboardLayout.useEffect": ()=>{
            ...
            if (isLoaded && userId) {
                ...
                // If the user is not authenticated, handle potential auth errors
                try {
                    // Check for any auth errors in the URL
                    const urlParams = new URLSearchParams(window.location.search);
                    const errorParam = urlParams.get('error');
                    if (errorParam) {
                        // Create an error object to pass to the handler
                        const error = new Error(decodeURIComponent(errorParam));
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2f$authUtils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["handleAuthError"])(error, router);
                    }
                } catch (err) {
...
const PersonalizedRecommendationsWidget = ({ recommendations = [], lastUpdated = "Never" })=>{
    ...
    const groupedRecommendations = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "PersonalizedRecommendationsWidget.useMemo[groupedRecommendations]": ()=>{
            try {
                ...
                recommendations.forEach({
                    "PersonalizedRecommendationsWidget.useMemo[groupedRecommendations]": (rec)=>{
    ...
    const availableTypes = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "PersonalizedRecommendationsWidget.useMemo[availableTypes]": ()=>{
            return Object.keys(groupedRecommendations).filter({
                "PersonalizedRecommendationsWidget.useMemo[availableTypes]": (type)=>groupedRecommendations[type].length > 0
            }["PersonalizedRecommendationsWidget.useMemo[availableTypes]"]);
        }
    }["PersonalizedRecommendationsWidget.useMemo[availableTypes]"], [
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: availableTypes.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        currentRecommendation && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "flex flex-col h-full",
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        activeType && groupedRecommendations[activeType].length > 2 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(PersonalizedRecommendationsWidget, "r2ORpPUd1PFJcNEzNwutbSzknQA=");
...
"[project]/src/app/utils/apiUtils.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/components/dashboard/widgets/DailySpeakingTipWidget.jsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const DailySpeakingTipWidget = ()=>{
    ...
    const [isLoading, setIsLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const [error, setError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [dailyTip, setDailyTip] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [currentDayName, setCurrentDayName] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    const { fetchWithRetry } = __turbopack_context__.r("[project]/src/app/utils/apiUtils.js [app-client] (ecmascript)");
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DailySpeakingTipWidget.useEffect": ()=>{
            const timer = setTimeout({
                "DailySpeakingTipWidget.useEffect.timer": ()=>{
                    setIsLoaded(true);
                }
            }["DailySpeakingTipWidget.useEffect.timer"], 10);
            return ({
                "DailySpeakingTipWidget.useEffect": ()=>clearTimeout(timer)
            })["DailySpeakingTipWidget.useEffect"];
        }
    }["DailySpeakingTipWidget.useEffect"], []);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DailySpeakingTipWidget.useEffect": ()=>{
            ...
            const fetchDailyTip = {
                "DailySpeakingTipWidget.useEffect.fetchDailyTip": async ()=>{
                    try {
                        setIsLoading(true);
                        ...
                        if (retryCount < 3) {
                            ...
                            setTimeout({
                                "DailySpeakingTipWidget.useEffect.fetchDailyTip": ()=>{
                                    setRetryCount({
                                        "DailySpeakingTipWidget.useEffect.fetchDailyTip": (prevCount)=>prevCount + 1
                                    }["DailySpeakingTipWidget.useEffect.fetchDailyTip"]);
                                // This will trigger the useEffect again due to retryCount dependency
                                }
                            }["DailySpeakingTipWidget.useEffect.fetchDailyTip"], retryDelay);
                        ...
                        const fallbackTip = fallbackTips.find({
                            "DailySpeakingTipWidget.useEffect.fetchDailyTip": (tip)=>tip.dayOfWeek === currentDay
                        }["DailySpeakingTipWidget.useEffect.fetchDailyTip"]) || fallbackTips[0];
            ...
            }["DailySpeakingTipWidget.useEffect.timer"], initialDelay);
            return ({
                "DailySpeakingTipWidget.useEffect": ()=>clearTimeout(timer)
            })["DailySpeakingTipWidget.useEffect"];
        }
...
_s(DailySpeakingTipWidget, "xCZZIuS+MnIKtOtE0DeCNUiGhEw=");
_c = DailySpeakingTipWidget;
const __TURBOPACK__default__export__ = DailySpeakingTipWidget;
var _c;
__turbopack_context__.k.register(_c, "DailySpeakingTipWidget");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
"[project]/src/app/components/auth/AuthCheck.jsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function AuthCheck({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthCheck.useEffect": ()=>{
            ...
            // Add a small delay to ensure Clerk has time to initialize
            const timer = setTimeout({
                "AuthCheck.useEffect.timer": ()=>{
                    checkAuth();
                }
            }["AuthCheck.useEffect.timer"], 300);
            return ({
                "AuthCheck.useEffect": ()=>clearTimeout(timer)
            })["AuthCheck.useEffect"];
        }
    }["AuthCheck.useEffect"], [
        isLoaded,
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        fileName: "[project]/src/app/components/auth/AuthCheck.jsx",
                        lineNumber: 52,
                        columnNumber: 11
                    }, this),
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
_s(AuthCheck, "jQ3vYQbpTa8janjQfrkpNP/cn5Q=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$nextjs$2f$dist$2f$esm$2f$client$2d$boundary$2f$PromisifiedAuthProvider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__usePromisifiedAuth__as__useAuth$3e$__["useAuth"]
    ];
});
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$dashboard$2f$widgets$2f$DailySpeakingTipWidget$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/components/dashboard/widgets/DailySpeakingTipWidget.jsx [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$dashboard$2f$ui$2f$WidgetCard$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/components/dashboard/ui/WidgetCard.jsx [app-client] (ecmascript)");
// Import AuthCheck component
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$auth$2f$AuthCheck$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/components/auth/AuthCheck.jsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function DashboardPage() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$auth$2f$AuthCheck$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
...
function DashboardContent() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DashboardContent.useEffect": ()=>{
            ...
            }["DashboardContent.useEffect.timer"], 500);
            return ({
    ...
    // Import fetchWithRetry from apiUtils
    const { fetchWithRetry } = __turbopack_context__.r("[project]/src/lib/api/apiUtils.js [app-client] (ecmascript)");
    // Track data loading status
    const [dataLoadingStatus, setDataLoadingStatus] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        userStats: 'idle',
        speechMetrics: 'idle',
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DashboardContent.useEffect": ()=>{
            if ("TURBOPACK compile-time truthy", 1) {
                ...
                console.error = ({
                    "DashboardContent.useEffect": function(...args) {
                        // Check if this is a mongoose or fetch error we want to suppress
                        const errorString = args.join(' ');
                        if (errorString.includes('mongoose') || errorString.includes('set is not a function') || errorString.includes('Request timed out') || errorString.includes('Failed to fetch')) {
        ...
        "DashboardContent.useEffect": ()=>{
            if (isUserLoaded && user) {
                ...
                const fetchAllDashboardData = {
                    "DashboardContent.useEffect.fetchAllDashboardData": async ()=>{
                        try {
                            // Wrap each fetch in a try/catch to prevent unhandled promise rejections
                            const safelyFetch = {
                                "DashboardContent.useEffect.fetchAllDashboardData.safelyFetch": async (fetchFn, isInitialLoad)=>{
                                    try {
                            ...
                            }["DashboardContent.useEffect.fetchAllDashboardData.safelyFetch"];
                            ...
                            const failedFetches = results.filter({
                                "DashboardContent.useEffect.fetchAllDashboardData.failedFetches": (r)=>r.status === 'rejected' || r.status === 'fulfilled' && r.value?.success === false
                            }["DashboardContent.useEffect.fetchAllDashboardData.failedFetches"]);
                            if (failedFetches.length > 0) {
                                ...
                                setTimeout({
                                    "DashboardContent.useEffect.fetchAllDashboardData": ()=>{
                                        results.forEach({
                                            "DashboardContent.useEffect.fetchAllDashboardData": (result, index)=>{
                                ...
                                }["DashboardContent.useEffect.fetchAllDashboardData"], 2000);
                            }
                        } catch (error) {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "lg:col-span-4",
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$components$2f$dashboard$2f$widgets$2f$DailySpeakingTipWidget$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                                fileName: "[project]/src/app/dashboard/page.jsx",
                                lineNumber: 974,
                                columnNumber: 13
                            }, this)
...
_s(DashboardContent, "AlUaw8P3TjKceVSSytAXWcwkDHw=", false, function() {
    return [
...
//# sourceMappingURL=src_d0a0f151._.js.map